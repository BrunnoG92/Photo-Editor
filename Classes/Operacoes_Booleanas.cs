...
namespace Photo_Editor.Classes
{
    ...
    {
        public static Bitmap ConverteParaAND(Image Imagem01, Image Imagem02)
        {
        ...
        public static Bitmap ConverteParaOR(Image Imagem01, Image Imagem02)
        {
            Bitmap Imagem1 = new Bitmap(Imagem01);
            Bitmap Imagem2 = new Bitmap(Imagem02);
        ...
        public static Bitmap ConverteParaXOR(Image Imagem01, Image Imagem02)
        {
            try
            {
                Bitmap Imagem1 = new Bitmap(Imagem01);
